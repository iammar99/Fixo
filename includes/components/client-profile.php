...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <!-- Profile Header -->
    <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-2xl p-6 md:p-8 text-white mb-8">
        <div class="flex flex-col md:flex-row items-center md:items-start justify-between">
            <div class="flex items-center mb-6 md:mb-0">
                ...
                <div class="ml-6">
                    ...
                    <p class="text-blue-100 mt-1">Customer</p>
                    <p class="text-blue-100 mt-2">
                        <i class="fas fa-calendar-alt mr-2"></i>
                        Member since <?php echo date('F Y', strtotime($user_data['createdat'])); ?>
                    </p>
                </div>
            </div>
            <button class="edit-btn bg-white text-blue-600 font-semibold py-3 px-6 rounded-xl hover:bg-blue-50">
        ...
        <div class="bg-white rounded-2xl p-6 shadow-lg">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800">Customer</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-lg">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800">
                        <?php echo ($user_data['isAdmin'] == 1) ? 'Yes' : 'No'; ?>
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="space-y-4">
                <div class="flex items-center p-3 bg-gray-50 rounded-xl">
                    ...
                    <div>
                        ...
                        <p class="font-medium">#<?php echo $user_data['id']; ?></p>
                    </div>
                </div>
                ...
                <div class="flex items-center p-3 bg-gray-50 rounded-xl">
                    ...
                    <div>
                        ...
                        <p class="font-medium"><?php echo date('M d, Y', strtotime($user_data['createdat'])); ?></p>
                    </div>
                </div>
                ...
                <div class="flex items-center p-3 bg-gray-50 rounded-xl">
                    ...
                    <div>
                        <p class="text-sm text-gray-500">Admin Privileges</p>
                        <p class="font-medium">
                            <?php if ($user_data['isAdmin'] == 1): ?>
                                <span class="text-indigo-600 font-bold">Administrator</span>
                            <?php else: ?>
    ...
    <div id="editProfileModal"
        ...
        <div class="relative top-20 mx-auto p-5 border w-full max-w-2xl shadow-lg rounded-2xl bg-white">
            ...
            <!-- Modal Body -->
            <div class="mt-6">
                <form id="editProfileForm" action="Proccessing_pages/Profile/edit-client-profile.php" method="POST">
                    <div class="space-y-6">
                        <!-- Full Name -->
                        <div>
                        ...
                        <div>
                            <label for="address" class="block text-sm font-medium text-gray-700 mb-2">
                                <i class="fas fa-map-marker-alt text-purple-600 mr-2"></i>Address
                            </label>
                    ...
                    <div class="flex justify-end space-x-4 mt-8 pt-4 border-t">
                        ...
                        <button type="submit"
                            class="px-6 py-3 bg-blue-600 text-white font-medium rounded-xl hover:bg-blue-700 transition flex items-center">
